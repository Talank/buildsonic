...
public class POM {
    ...
    private HashMap<String, String> compilationConfigurations = new HashMap<>();
    ...
    public void addCompilationConfigurations(String name, String value) {
        compilationConfigurations.put(name,value);
    }
...
//            }
        ...
        for (Dependency dep : this.dependencies) {
            ...
            if (!dep.getVersion().equals("")) {
                if (dep.getVersion().contains("$")) {
                    ...
                    Dependency dependency = new Dependency(dep.getGroupID(), dep.getArtifactID(), version, dep.getVersionSpecifier());
                    deps.add(dependency);
                } else {
                    deps.add(dep);
                }
    ...
    public boolean hasParent() {
        return this.parentArtifactId != null;
//        return parent != null
